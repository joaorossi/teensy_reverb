...
static void 
_do_comb_apf(struct comb_apf *apf, int32_t *in_buf, int32_t *out_buf)
{
...
static void
_do_comb_lpf(struct comb_lpf *lpf, int32_t *in_buf, int32_t *out_buf)
{
...
void
AudioEffectReverb::reverb_time(float rt)
{
  if (rt <= 0.0)
    return;
